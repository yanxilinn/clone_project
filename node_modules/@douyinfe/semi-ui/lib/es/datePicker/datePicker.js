...
export default class DatePicker extends BaseComponent {
  ...
  renderDateInput() {
    ...
    return insetInput ? /*#__PURE__*/React.createElement(DateInput, Object.assign({}, insetInputProps, {
      insetInput: true
    })) : null;
  }
  ...
  renderInner(extraProps) {
    ...
    const inputCls = classnames("".concat(cssClasses.PREFIX, "-input"), {
      ...
      ["".concat(cssClasses.PREFIX, "-range-input-").concat(size)]: isRangeType && size,
      ...
      ["".concat(cssClasses.PREFIX, "-range-input-").concat(validateStatus)]: isRangeType && validateStatus
    });
