...
class CarouselIndicator extends React.PureComponent {
    ...
    for (let i = 0; i < total; i++) {
      indicatorContent.push( /*#__PURE__*/React.createElement("span", {
        ...
        className: cls(["".concat(cssClasses.CAROUSEL_INDICATOR, "-item")], {
          ...
          ["".concat(cssClasses.CAROUSEL_INDICATOR, "-item-").concat(theme)]: theme,
          ["".concat(cssClasses.CAROUSEL_INDICATOR, "-item-").concat(size)]: size
        }),
  ...
  render() {
    ...
    const classNames = cls(className, {
      ...
      ["".concat(cssClasses.CAROUSEL_INDICATOR, "-").concat(type)]: type,
      ["".concat(cssClasses.CAROUSEL_INDICATOR, "-").concat(position)]: position
    });
