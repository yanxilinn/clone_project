...
class DatePicker extends _baseComponent.default {
  ...
  renderDateInput() {
    ...
    return insetInput ? /*#__PURE__*/_react.default.createElement(_dateInput.default, Object.assign({}, insetInputProps, {
      insetInput: true
    })) : null;
  }
  ...
  renderInner(extraProps) {
    ...
    const inputCls = (0, _classnames.default)("".concat(_constants.cssClasses.PREFIX, "-input"), {
      ...
      ["".concat(_constants.cssClasses.PREFIX, "-range-input-").concat(size)]: isRangeType && size,
      ...
      ["".concat(_constants.cssClasses.PREFIX, "-range-input-").concat(validateStatus)]: isRangeType && validateStatus
    });
