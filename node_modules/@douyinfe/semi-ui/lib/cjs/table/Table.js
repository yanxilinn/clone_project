...
class Table extends _baseComponent.default {
  ...
  render() {
    ...
    const wrapCls = (0, _classnames.default)({
      ["".concat(prefixCls, "-").concat(_constants.strings.SIZE_SMALL)]: size === _constants.strings.SIZE_SMALL,
      ["".concat(prefixCls, "-").concat(_constants.strings.SIZE_MIDDLE)]: size === _constants.strings.SIZE_MIDDLE,
