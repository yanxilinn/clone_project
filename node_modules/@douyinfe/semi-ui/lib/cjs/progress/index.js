...
class Progress extends _react.Component {
  ...
  renderCircleProgress() {
    ...
    const classNames = {
      wrapper: (0, _classnames.default)("".concat(prefixCls, "-circle"), className),
      svg: (0, _classnames.default)("".concat(prefixCls, "-circle-ring")),
      circle: (0, _classnames.default)("".concat(prefixCls, "-circle-ring-inner"))
    };
  ...
  renderLineProgress() {
    ...
    const progressWrapperCls = (0, _classnames.default)(prefixCls, className, {
      ["".concat(prefixCls, "-horizontal")]: direction === _constants.strings.DEFAULT_DIRECTION,
      ["".concat(prefixCls, "-vertical")]: direction !== _constants.strings.DEFAULT_DIRECTION,
